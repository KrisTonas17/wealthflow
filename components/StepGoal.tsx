...
export default function StepGoal({ incomeData, budgetData, allocationData, monthlyInvesting, onNext, onBack, onRestart }: Props) {
  ...
  // monthlyInvesting comes from actual portfolio config (passed from page.tsx)
