...
export default function StepGoal({ incomeData, budgetData, allocationData, onBack, onRestart }: Props) {
  ...
  return (
    <div className="fade-up">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12 }}>
        ...
        <button className="btn-primary" onClick={onRestart} style={{ background: 'transparent', border: '1px solid var(--border)', color: 'var(--text-muted)' }}>
          ↺ Start Over
        </button>
      </div>
    </div>
